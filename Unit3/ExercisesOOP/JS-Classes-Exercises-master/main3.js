...
// Create a new property model and display it
...
//    }
    ...
    increase_volume(amount) {
        this.volume += amount;
        // Si this.volume es mayor que 100 se deja en 100, sino en this.volume
        (this.volume > 100) ? this.volume = 100 : this.volume = this.volume;
    }
    
    decrease_volume(amount) {
        this.volume -= amount;
        // Si this.volume es menor que 0 se deja en 0, sino en this.volume
        (this.volume < 0) ? this.volume = 0 : this.volume = this.volume;
    }
    
    set_channel(number) {
        // Si está fuera del rango de canales el canal no cambia
